...
import 'schema/debates_record.dart';
import 'schema/meeting_record.dart';
import 'schema/debate_contents_record.dart';
...
export 'schema/debates_record.dart';
export 'schema/meeting_record.dart';
export 'schema/debate_contents_record.dart';
...
/// Functions to query DebatesRecords (as a Stream and as a Future).
Future<int> queryDebatesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DebatesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DebatesRecord>> queryDebatesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DebatesRecord.collection,
      DebatesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DebatesRecord>> queryDebatesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query DebateContentsRecords (as a Stream and as a Future).
Future<int> queryDebateContentsRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DebateContentsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DebateContentsRecord>> queryDebateContentsRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      DebateContentsRecord.collection(parent),
      DebateContentsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DebateContentsRecord>> queryDebateContentsRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<int> queryMemberRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      MemberRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
