...
import 'b_create_model.dart';
export 'b_create_model.dart';

class BCreateWidget extends StatefulWidget {
  const BCreateWidget({super.key});

  static String routeName = 'B_Create';
  static String routePath = '/bCreate';

  @override
  State<BCreateWidget> createState() => _BCreateWidgetState();
}

class _BCreateWidgetState extends State<BCreateWidget>
    with TickerProviderStateMixin {
  late BCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BCreateModel());
