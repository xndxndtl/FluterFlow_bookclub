...
import 'faf_edit_profile_form_model.dart';
export 'faf_edit_profile_form_model.dart';

class FafEditProfileFormWidget extends StatefulWidget {
  const FafEditProfileFormWidget({
    super.key,
    String? title,
    String? confirmButtonText,
    required this.navigateAction,
  })  : this.title = title ?? '프로필 정보',
        this.confirmButtonText = confirmButtonText ?? '프로필 저장';
  ...
  @override
  State<FafEditProfileFormWidget> createState() =>
      _FafEditProfileFormWidgetState();
}

class _FafEditProfileFormWidgetState extends State<FafEditProfileFormWidget> {
  late FafEditProfileFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FafEditProfileFormModel());
