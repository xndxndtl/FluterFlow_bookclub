...
import 'd_e_club_mgmt_model.dart';
export 'd_e_club_mgmt_model.dart';

class DEClubMgmtWidget extends StatefulWidget {
  const DEClubMgmtWidget({
    super.key,
    this.clubinfo,
  });
  ...
  @override
  State<DEClubMgmtWidget> createState() => _DEClubMgmtWidgetState();
}

class _DEClubMgmtWidgetState extends State<DEClubMgmtWidget> {
  late DEClubMgmtModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DEClubMgmtModel());
    ...
    _model.clubNameTextController ??=
        TextEditingController(text: widget!.clubinfo?.clubName);
    _model.clubNameFocusNode ??= FocusNode();

    _model.clubDescriptionTextController ??=
        TextEditingController(text: widget!.clubinfo?.clubDescription);
    ...
    return Form(
      ...
      child: Padding(
        ...
        child: StreamBuilder<ClubsRecord>(
          stream: ClubsRecord.getDocument(widget!.clubinfo!.reference),
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final clubWaitingMemList =
                                  columnClubsRecord.clubJoinRequest.toList();
                              ...
                              return ListView.builder(
                                ...
                                itemCount: clubWaitingMemList.length,
                                itemBuilder:
                                    (context, clubWaitingMemListIndex) {
                                  final clubWaitingMemListItem =
                                      clubWaitingMemList[
                                          clubWaitingMemListIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        16.0, 4.0, 16.0, 8.0),
                                    child: StreamBuilder<UsersRecord>(
                                      stream: UsersRecord.getDocument(
                                          clubWaitingMemListItem),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        if (!snapshot.hasData) {
                                          return Center(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final clubMemList =
                                  columnClubsRecord.clubMembers.toList();
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, clubMemListIndex) {
                                  final clubMemListItem =
                                      clubMemList[clubMemListIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        16.0, 4.0, 16.0, 8.0),
                                    child: StreamBuilder<UsersRecord>(
                        ...
                        onPressed: () async {
                          var confirmDialogResponse = await showDialog<bool>(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    content: Text(
                                        '정말 삭제하시겠습니까? 클럽 삭제 시, 복구할 수 없습니다.'),
                                    actions: [
                                      TextButton(
                                        onPressed: () => Navigator.pop(
                          ...
                          // updateUserInfo
                          await widget!.clubinfo!.reference.delete();
